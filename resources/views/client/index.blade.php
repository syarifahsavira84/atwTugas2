    ...
    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="size" class="form-control" value="{{$size ?? ""}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="harga_min" class="form-control" placeholder="100000" value="{{$harga_min ?? ""}}">
                                </div>
                                <div class="form-group">
                                    <label for="" class="control-label">Harga Max</label>
                                    <input type="text" name="harga_max" class="form-control" placeholder="200000" value="{{$harga_max ?? ""}}">
                                </div>
                        <div class="form-group">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                    <div class="shop-cat-box">
                        <h5>Ukuran : M</h5> <h5>Harga : 150000</h5>
                        <img class="img-fluid" src="images/t-shirts-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Baju Kaos</a>
                        
                    </div>
                    <div class="shop-cat-box">
                        <h5>Ukuran : M</h5> <h5>Harga : 120000</h5>
                        <img class="img-fluid" src="images/shirt-img.jpg" alt="" />
                        <a class="btn hvr-hover" href="#">Kemeja Panjang</a>
                    </div>
                </div>
    </div>
